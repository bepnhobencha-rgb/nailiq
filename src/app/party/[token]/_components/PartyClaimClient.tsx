        ...
        <div className="border-t border-gray-100 px-4 py-3 space-y-2">
          ...
          {!editOpen && (
            <button
              ...
              className="w-full text-left text-xs font-medium text-gray-500 hover:text-gray-900 transition-colors flex items-center gap-1"
            >
              <span>💬</span>
    ...
    <form onSubmit={handleSubmit} className="space-y-2 pt-1">
      ...
      <div className="flex gap-2">
        <button
          type="submit"
          disabled={isPending}
          className="flex-1 rounded-lg bg-gray-900 py-2 text-xs font-semibold text-white hover:bg-gray-700 disabled:opacity-60 transition-colors"
        >
  ...
  if (success) {
    return (
      <div className="space-y-2 pt-1">
        <p className="text-xs text-emerald-600 font-medium">✓ {t.changeRequestSuccess}</p>
        <button
          type="button"
          onClick={onClose}
