        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2">
          {quotes.map((q, i) => (
            <motion.figure
              ...
              className="relative rounded-2xl border border-nq-border/40 bg-nq-surface/40 p-6 md:p-7"
            >
              <span
                aria-hidden
                className="absolute left-5 top-3 font-[family-name:var(--font-landing-playfair),ui-serif,Georgia,serif] text-6xl italic leading-none text-nq-primary/30"
              >
                &ldquo;
              </span>
              <blockquote className="relative mt-4 text-base leading-relaxed text-nq-foreground md:text-lg">
                {q.body}
              </blockquote>
              <figcaption className="mt-5 flex items-center gap-3">
                ...
                <span className="text-sm text-nq-muted">{q.attribution}</span>
              </figcaption>
            </motion.figure>
          ))}
        </div>
