...
type AutoMapResult = Pick<Design, "serviceIds" | "addonServiceIds" | "defaultServiceId" | "confidence" | "reason" | "attributes" | "status"> & { designId: string; error?: string };
