...
export const CARD_PROTECTION_COPY = {
  en: {
    ...
    paused: "Card saving is temporarily paused. Your appointment is reserved, but card protection is not active. Please reopen this link later or ask the salon for help.",
    cancelled: "Appointment cancelled", cancelledDetail: "This appointment is cancelled. No card needs to be saved for it.",
    ...
    retryGuidance: "Check your card details or use another card, then try saving again. If it still fails, contact the salon.",
  ...
  vi: {
    ...
    paused: "Việc lưu thẻ đang tạm dừng. Lịch hẹn vẫn được giữ, nhưng bảo vệ hủy trễ/no-show chưa kích hoạt. Vui lòng mở lại liên kết sau hoặc nhờ salon hỗ trợ.",
    cancelled: "Lịch hẹn đã hủy", cancelledDetail: "Lịch hẹn này đã hủy. Bạn không cần lưu thẻ cho lịch hẹn này.",
    ...
    retryGuidance: "Kiểm tra thông tin thẻ hoặc dùng thẻ khác, rồi thử lưu lại. Nếu vẫn không được, vui lòng liên hệ salon.",
