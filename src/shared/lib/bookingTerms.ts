...
export function bookingTerms(lang: TermsLang, salonName: string): string {
  ...
  if (lang === "vi") {
    return [
      ...
      `3. Rủi ro dịch vụ: Một số dịch vụ làm đẹp có thể gây phản ứng (vd dị ứng, kích ứng da). Vui lòng báo ${s} về dị ứng/tình trạng sức khoẻ trước khi làm. Bạn hiểu và chấp nhận rủi ro thông thường của dịch vụ đã chọn.`,
  ...
  return [
    ...
    `3. Service risks: Some beauty services can cause reactions (e.g. allergies, skin irritation). Please tell ${s} about allergies/health conditions before your service. You understand and accept the ordinary risks of the service you choose.`,
