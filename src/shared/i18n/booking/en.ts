...
export const bookingEn = {
  ...
  timeBestSuggestions: "Best suggestions",
  timeMorning: "Morning",
  timeMidday: "Midday",
  timeAfternoon: "Afternoon",
  timeEvening: "Evening",
  timeOpenCount: "{n} open",
  timeShowAll: "Show all times",
  timeShowLess: "Show fewer times",
  next: "Continue",
  back: "Back",
  ...
  otpStepSubheading: "A code is being sent by SMS to",
  ...
  otpEmailResendCta: "Resend by email",
  otpEmailStepSubheading: "A code is being sent by email to",
  otpEmailSent: "A code is also being sent by email",
  otpEmailSending: "Emailing code…",
  otpSmsSendCta: "Send code by SMS",
  otpSmsResendCta: "Resend by SMS",
  otpCallSalonHint: "Still having trouble?",
  otpCallSalonCta: "Call us to book",
