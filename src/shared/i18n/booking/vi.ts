...
export const bookingVi: BookingMessages = {
  ...
  cardWebviewCopied: "Đã sao chép link",
  noShowConsent:
  ...
  timeBestSuggestions: "Gợi ý tốt nhất",
  timeMorning: "Buổi sáng",
  timeMidday: "Buổi trưa",
  timeAfternoon: "Buổi chiều",
  timeEvening: "Buổi tối",
  timeOpenCount: "còn {n} giờ",
  timeShowAll: "Xem tất cả giờ",
  timeShowLess: "Thu gọn giờ",
  next: "Tiếp theo",
  back: "Quay lại",
  ...
  otpStepSubheading: "Mã đang được gửi qua SMS đến",
  ...
  otpAndEmail: "và email",
  otpEmailFallbackCta: "Không nhận được tin nhắn? Gửi mã qua email",
  otpEmailInputLabel: "Nhập email để nhận mã",
  otpEmailPlaceholder: "ban@email.com",
  otpEmailSendCta: "Gửi mã qua email",
  otpEmailResendCta: "Gửi lại qua email",
  otpEmailStepSubheading: "Mã đang được gửi qua email đến",
  otpEmailSent: "Mã cũng đang được gửi qua email",
  otpEmailSending: "Đang gửi mã qua email…",
  otpSmsSendCta: "Gửi mã qua SMS",
  otpSmsResendCta: "Gửi lại qua SMS",
  otpCallSalonHint: "Vẫn chưa nhận được?",
  otpCallSalonCta: "Gọi cho chúng tôi để đặt lịch",
