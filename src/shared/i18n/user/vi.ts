...
export const userVi: UserMessages = {
  ...
  salonSettings: {
    ...
    brandColor: {
      ...
      themeLight: "Sáng",
      extract: {
        sectionLabel: "Lấy màu từ website",
        hint: "Dán URL website tiệm — chúng tôi sẽ tự nhận màu thương hiệu từ ảnh OG.",
        placeholder: "https://tiem-cua-ban.com",
        extract: "Phân tích",
        extracting: "Đang phân tích…",
        apply: "Áp dụng",
        errorInvalidUrl: "URL không hợp lệ. Dùng dạng https://…",
        errorFetchFailed: "Không tải được trang. Kiểm tra URL và thử lại.",
        errorNoImage: "Trang này không có ảnh OG / hero.",
