...
\restrict 8ICo744WbwnPfyQGXG7RuE88eAutVI4eMxpwDrLJGkNfp4j5jo5roASx10Kgrwo
...
CREATE POLICY "Public read trend cache" ON public.ai_trend_cache FOR SELECT TO authenticated, anon USING (true);
...
CREATE POLICY "anon read staff_services" ON public.staff_services FOR SELECT TO authenticated, anon USING (true);
...
CREATE POLICY "anon read staff_shifts" ON public.staff_shifts FOR SELECT TO authenticated, anon USING (true);
...
CREATE POLICY "anon read staff_unavailability" ON public.staff_unavailability FOR SELECT TO authenticated, anon USING (true);
...
CREATE POLICY reviews_select_by_token ON public.reviews FOR SELECT TO authenticated, anon USING (true);
...
CREATE POLICY salon_page_sections_public_read ON public.salon_page_sections FOR SELECT TO authenticated, anon USING ((is_visible = true));
...
\unrestrict 8ICo744WbwnPfyQGXG7RuE88eAutVI4eMxpwDrLJGkNfp4j5jo5roASx10Kgrwo
