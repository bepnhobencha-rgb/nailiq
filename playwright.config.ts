...
export default defineConfig({
  ...
  webServer: {
    ...
    command:
      "NEXT_PUBLIC_DEMO_OTP=true DEMO_OTP=true NAILIQ_TEST_BYPASS_SLUG_PIN=1 AI_PREFILL_E2E_MOCK=services DISABLE_OUTBOUND_SMS=1 DISABLE_OUTBOUND_CALLS=1 npm run dev",
