...
('d6000000-0000-4000-8000-000000000010','d6000000-0000-4000-8000-000000000001',
 ...
 'Solo QA','qa@example.test',transaction_timestamp()+interval '3 days',transaction_timestamp()+interval '3 days 30 minutes','pending',3000,NULL,false,false),
...
('d6000000-0000-4000-8000-000000000030','d6000000-0000-4000-8000-000000000001',
 ...
 ((transaction_timestamp()+interval '3 days') AT TIME ZONE 'America/Vancouver')::date,
